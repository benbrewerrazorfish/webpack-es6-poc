...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UniqueFeature = __webpack_require__(5);

	var UniqueFeature = _interopRequire(_UniqueFeature);

	/*****************************************************************************
	 * special feature page 
	 *****************************************************************************/

	var SpecialFeature = function SpecialFeature() {
		_classCallCheck(this, SpecialFeature);

		_log.log('SpecialFeature page constructor');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _log$debug = __webpack_require__(1);
	...
	var UniqueFeature = (function () {
		function UniqueFeature() {
			_classCallCheck(this, UniqueFeature);

			this.render();
		}

		_createClass(UniqueFeature, [{
			key: 'render',
			value: function render() {
				_log$debug.debug('Unique Special Feature');
				this.testBootstrapImport();
			}
		}, {
			key: 'testBootstrapImport',
			value: function testBootstrapImport() {
			...
			key: 'onBootstrapButtonClick',
			value: function onBootstrapButtonClick(e) {
				e.preventDefault();
				alert('click');
			}
		}, {
			key: 'testUnderscoreImport',
			value: function testUnderscoreImport() {

				//test underscore import
				var underscoreTest = _.last([34, 1, 55, 2, 20], 1);
				_log$debug.debug('underscore test result: ' + underscoreTest);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery");+(function (a) {
	  ...
	  });c.VERSION = "3.3.2", c.TRANSITION_DURATION = 600, c.DEFAULTS = { interval: 5000, pause: "hover", wrap: !0, keyboard: !0 }, c.prototype.keydown = function (a) {
